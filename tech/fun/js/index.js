$(function(){
var tarcie = (1 / 6);
var cialo_x = 0, cialoRuchX = 0;
function animacja_cialo(){
  cialo_x += (cialoRuchX - cialo_x) * tarcie;
  $('.cialo').css({
    '-webkit-transform': 'rotate(' + -cialo_x + 'deg)',
    'transform': 'rotate(' + -cialo_x + 'deg)'
  });
  window.requestAnimationFrame(animacja_cialo);
}
var uszy_x = 0, uszy_y = 0, uszyRuchX = 0, uszyRuchY = 0;
function animacja_uszy(){
  uszy_x += (uszyRuchX - uszy_x) * tarcie;
  uszy_y += (uszyRuchY - uszy_y) * tarcie;
  $('.uszy').css({
    '-webkit-transform': 'translate(' + -uszy_x + 'px, ' + -uszy_y + 'px) rotateY(' + -uszy_x*12 + 'deg)',
    'transform': 'translate(' + -uszy_x + 'px, ' + -uszy_y + 'px) rotateY(' + -uszy_x*12 + 'deg)'
  });
  window.requestAnimationFrame(animacja_uszy);
}
var zrenica_x = 0, zrenica_y = 0, zrenicaRuchX = 0, zrenicaRuchY = 0;
function animacja_oko_zrenice(){
  ...
  window.requestAnimationFrame(animacja_oko_zrenice);
}
var oko_x = 0, oko_y = 0, okoRuchX = 0, okoRuchY = 0;
function animacja_oko(){
  ...
  window.requestAnimationFrame(animacja_oko);
}
var powieka_gorna_x = 0, powieka_gorna_y = 0,powiekaGornaRuchX = 0, powiekaGornaRuchY = 0;
function animacja_powieka_gorna(){
  ...
  window.requestAnimationFrame(animacja_powieka_gorna);
}
var powieka_dolna_x = 0, powieka_dolna_y = 0,powiekaDolnaRuchX = 0, powiekaDolnaRuchY = 0;
function animacja_powieka_dolna(){
  ...
  window.requestAnimationFrame(animacja_powieka_dolna);
}
var usta_x = 0, usta_y = 0, ustaRuchX = 0, ustaRuchY = 0;
function animacja_usta(){
  ...
  window.requestAnimationFrame(animacja_usta);
}
$(window).on('mousemove click', function(e) {
  var lMouseX = Math.max(-100, Math.min(100, $(window).width() / 2 - e.clientX));
  var lMouseY = Math.max(-100, Math.min(100, ($(window).height() / 2) - e.clientY));
  cialoRuchX = (5 * lMouseX) / 200;
  uszyRuchX = (3 * -lMouseX) / 90;
...
animacja_cialo();
animacja_uszy();
animacja_oko_zrenice();
animacja_oko();
animacja_powieka_gorna();
animacja_powieka_dolna();
animacja_usta();
});